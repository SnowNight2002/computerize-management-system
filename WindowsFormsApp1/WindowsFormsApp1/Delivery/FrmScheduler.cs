...
namespace BLtd
{
    public partial class FrmScheduler : Form
    {
        ...
        private void RetrieveDeliveryOrder(DataTable DeliveryList)
        {
            ...
            {
                workerUc = new WorkerUserControl();
        ...
        private void AddToTimeTable(string slotNo, WorkerUserControl uc, bool isDelivery)
        {
        ...
        private void btnAutoAssign_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("You do not have permission to assign a worker!", "Warning", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
            else
            {
        ...
        {
            this.Hide();
            DialogResult dr = new frmHistory(CURRENT_USER).ShowDialog();
        ...
        {
            this.Hide();
            DialogResult dr = new frmMyTask(CURRENT_USER).ShowDialog();
            if (dr == DialogResult.Cancel)
            {
                this.Show();
            }
