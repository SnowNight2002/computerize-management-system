    ...
    public partial class admin2 : Form
    {
        ...
        private void update_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    MessageBox.Show("EmpID is incorrect.", "Message", MessageBoxButtons.OK, MessageBoxIcon.Information);
                }
        ...
        private void Create_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (str.Length == 0)
                {
                    MessageBox.Show("EmpID is Empty", "Message", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    return;
                }
                else if (str.Length <= 3)
                {
                    MessageBox.Show("EmpID Length need more than 4.", "Message", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    return;
                }
                ...
                if (txtEmpID.Text != "" && txtEmpName.Text != "" && txtEmpdep.Text != "" && txtusername.Text != "" && txtpw.Text != "" && txtsans.Text != "")
                {
                    ...
                    try
                    {
                        ...
                        cmd.ExecuteNonQuery();
                        conn.Close();
                        MessageBox.Show("New empolyee account has been created successfully!");
                    ...
                    MessageBox.Show("Please enter everything");
            }
            ...
            if (txtEmpID.Text != "" && txtEmpName.Text != "" && txtEmpdep.Text != "" && txtusername.Text != "" && txtpw.Text != "" && txtsans.Text != "")
            {
                ...
                if (dt.Rows.Count == 1)
                {
                    try
                    {
                        ...
                        cmd.ExecuteNonQuery();
                        con.Close();
                        MessageBox.Show("DELETE account has successfully!");
        ...
        private void txtEmpdep_SelectedIndexChanged(object sender, EventArgs e)
        {

        }

        private void txtsans_TextChanged(object sender, EventArgs e)
        {
