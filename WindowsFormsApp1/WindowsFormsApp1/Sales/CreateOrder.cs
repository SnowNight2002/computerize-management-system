...
namespace Better_Limited
{
    ...
    {
        public frmCreate(string employeeID, string position)
        {
            InitializeComponent();
        ...
        private void btnFinish_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                if (!CheckValidOrderID(txtOID.Text) && (txtPayment.Text == "Payment Receipt" || txtPayment.Text == "Deposit Receipt"))
                {
                    ...
                    {
                        MessageBox.Show("Please select your store region");
                    }
                    else if (txtOID.Text == "")
                    {
                        MessageBox.Show("Please input an order ID");
                    }
                    else
                    {
                        if (txtPayment.Text == "Payment Receipt")
                        {
                            ...
                            InsertPayment();
                            changeStock();
                            MessageBox.Show("Sales Order ID " + txtOID.Text + " is recorded successful.");
                            GoToAnotherForm();
                        }
                ...
                {
                    MessageBox.Show("You need to select a receipt type.");
                }
                else
                    MessageBox.Show("Sales Order ID " + txtOID.Text + " is duplicated.");
            }
        }
