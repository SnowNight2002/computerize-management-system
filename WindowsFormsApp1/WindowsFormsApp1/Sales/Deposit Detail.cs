...
{
    public partial class frmDepositDetail : Form
    {
        public frmDepositDetail(string orderID, string employeeID, string position, string paymentMethod, string empID, string region, string totalAmount)
        {
            InitializeComponent();
        ...
        {
            Print_Deposit deposit = new Print_Deposit();
            double calculate = 0;
