...
namespace WindowsFormsApp1
{
    ...
    public partial class Form2CN : Form
    {
        ...
        private void CPw_Click(object sender, EventArgs e)
        {
            ...
            try 
            {
                ...
                if (newpasswordtxt.Text.Trim() == newpassword2.Text.Trim())
                {
                    ...
                    {
                        MessageBox.Show("您的信息不正确。", "Message", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    }

                }
                else
                {
                    MessageBox.Show("两次输入必须一致", "Message", MessageBoxButtons.OK, MessageBoxIcon.Information);
                }
