...
{
    public partial class InventoryManagementSystemReceiptCN : Form
    {
        public InventoryManagementSystemReceiptCN()
        {
        ...
        public InventoryManagementSystemReceiptCN(int txtReOrderID1, string txtItemType1, string txtItemBrand1, string txtSupplier1, int txtItemQuantity1, int txtItemPrice1, int txtAmounts1, string txtReceiveDate1,
