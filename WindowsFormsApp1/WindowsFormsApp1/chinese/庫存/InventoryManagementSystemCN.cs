...
{
    public partial class InventoryManagementSystemCN : Form
    {
        public InventoryManagementSystemCN()
        {
            InitializeComponent();
            panelAddItems.Show();
            panelAddItems.Focus();
        ...
        private void InventoryManagementSystem_Load(object sender, EventArgs e)
        {
            ...
            using (var better_limited = new WindowsFormsApp1.better_limitedEntities())
            {
                ...
                MessageBox.Show("请注意, 您有 '" + orderDetail2 + "' 当前库存水平较低的商品.");
        ...
        {
            {
                InventoryManagementSystemPopUpFormCN PopupForm = new InventoryManagementSystemPopUpFormCN();
                PopupForm.Show();
            }
        }
