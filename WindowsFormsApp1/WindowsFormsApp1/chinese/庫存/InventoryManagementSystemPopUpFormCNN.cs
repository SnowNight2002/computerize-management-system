...
{
    public partial class InventoryManagementSystemPopUpFormCN : Form
    {
        public InventoryManagementSystemPopUpFormCN()
        {
        ...
        {
            InventoryManagementSystemReceiptCN form = new InventoryManagementSystemReceiptCN(txtReOrderID1, txtItemType1, txtItemBrand1, txtSupplier1, txtItemQuantity1, txtItemPrice1, txtAmounts1, txtReceiveDate1,
