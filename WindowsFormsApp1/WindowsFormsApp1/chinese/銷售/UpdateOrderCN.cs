...
{
    public partial class frmUpdateCN : Form
    {
        public frmUpdateCN(string orderID, string employeeID, string position)
        {
            InitializeComponent();
            ...
            txtPosition.Text = position;
                ...
                using (var orderContext = new WindowsFormsApp1.better_limitedEntities())
                {
                    ...
                    lblPrice.Text = "价格 = $" + txtPrice.Text;
        ...
        private void btnFinish_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                if (txtPayment.Text == "Deposit Receipt")
                {
                    ...
                    {
                        MessageBox.Show("请输入一个正确的客户ID");
                    }
                }
                    UpdateRecord();
                    MessageBox.Show(txtOID.Text + " 成功更新了");
