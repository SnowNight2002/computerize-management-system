...
{
    public partial class frmPayDetailCN : Form
    {
        public frmPayDetailCN(string orderID, string employeeID, string position, string paymentMethod, string empID, string region, string totalAmount)
        {
            InitializeComponent();
        ...
        {
            frmPrintCN print = new frmPrintCN();
