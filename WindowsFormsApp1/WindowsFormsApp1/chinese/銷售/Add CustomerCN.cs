...
{
    public partial class frmCustomerCN : Form
    {
        public frmCustomerCN()
        {
            InitializeComponent();
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("请输入完整的客户信息");
            }
            else
            {
                InsertCustomer();
                MessageBox.Show("一个新的客户 '" + txtName.Text + "' 创建成功.");
                frmCustomerCN custormer = new frmCustomerCN();
                this.Hide();
                custormer.Show();
            }
        }
