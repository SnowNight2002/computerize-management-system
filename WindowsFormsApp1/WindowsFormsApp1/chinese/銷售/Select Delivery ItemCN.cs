...
{
    public partial class frmSelectItemCN : Form
    {
        public frmSelectItemCN(string employeeID, string position, string install, string timeslot, string date)
        {
            InitializeComponent();
        ...
        private void btnFinish_Click(object sender, EventArgs e)
        {
            ...
            if (price == 0)
            {
                MessageBox.Show("请选择一个需要配送的货物");
            }
            else
            {
                InsertDelivery();
                MessageBox.Show("一个新的送货订单已经创建");
