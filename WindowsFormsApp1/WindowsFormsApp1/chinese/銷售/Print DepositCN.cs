...
{
    public partial class Print_DepositCN : Form
    {
        public string Date, OrderID, EmpID, PaymentMethod, TotalAmount, StoreRegion, Quantity, Price, ItemName, OutStanding, Deposit;
        ...
        private void Print_DepositCN_Load(object sender, EventArgs e)
        {
            labelDate.Text = Date;
            ...
            labelOut.Text = OutStanding;
            labelDeposit.Text = Deposit;
        }

        public Print_DepositCN()
        {
            InitializeComponent();
