...
namespace BLtd
{
    public partial class frmHistoryCN : Form
    {
        ...
        private void GetOrderDetail()
        {
            ...
            try
            {
                ...
                dgvHistory.Columns["deliveryid"].HeaderText = "送货 ID";
                dgvHistory.Columns["docreatedate"].HeaderText = "创建日期";
                dgvHistory.Columns["expectdeliverydate"].HeaderText = "交货日期";
                dgvHistory.Columns["deliverystatus"].HeaderText = "状态";
                dgvHistory.Columns["deliverycompleteDate"].HeaderText = "完成日期";
                dgvHistory.Columns["Customerid"].HeaderText = "客户 ID";
                dgvHistory.Columns["InstallationNeed"].HeaderText = "安装请求"; //**
        ...
        private void dgvHistory_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            DialogResult dr = new frmOrderDetailCN(dgvHistory.CurrentRow.Cells[0].Value.ToString(), null, CURRENT_USER, "Delivery Worker").ShowDialog();
        ...
        {
            lblNoFound.Text = dgvHistory.Rows.Count.ToString() + " 找到记录"; //**
        }
    }
}